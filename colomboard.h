...
struct usb_data {
	int xplCommand;
	int xplSubCommand;
	int comStatusHost; // 1 = changed
	int comFreq;  // COM 118.00 ... 136.975
	int comFreqFraction;
	int comFreqStandby;
	int comFreqStandbyFraction;
	int comStatusBoard;  // 1 = changed
	int comFreqIn;  // COM 118.00 ... 136.975
	int comFreqFractionIn;
	int comFreqStandbyIn;
	int comFreqStandbyFractionIn;
	int navStatusBoard;  // 1 = changed
	int navStatusHost;  // 1 = changed
	int navFreq;  // NAV 108.00 ... 117.975
	int navFreqFraction;
	int navFreqStandby;
